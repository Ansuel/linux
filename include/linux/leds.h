...
#define LED_BLINK_DISABLE		5
	 ...
	 * acceleration following the requested mode from the trigger.
	...
	int			(*hw_control_set)(struct led_classdev *led_cdev,
						  unsigned long flags);
	/*
	 * Get from the LED driver the current mode that the LED is using to
	 * blink using hardware acceleration and put them in flags.
