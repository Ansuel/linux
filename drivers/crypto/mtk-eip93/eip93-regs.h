...
/* #define   EIP93_INT_RD_DONE			BIT(16) Old revision */
#define   EIP93_INT_HALT			BIT(15)
/* #define   EIP93_INT_ERR_REG			BIT(13) NOT PRESENT */
/* #define   EIP93_INT_PRNG			BIT(12) NOT PRESENT */
...
/*
 * On old revision it's
 * #define   EIP93_INT_TYPE			BIT(1)
 * #define   EIP93_INT_PULSE_CLEAR		BIT(0)
 */
...
#define   EIP93_SA_CMD_DIRECTION		BIT(3) /* 0: outbount 1: inbound */
...
/*#define EIP93_REG_SA_READY		0x47c NONCE_SA_READY */
...
#define EIP93_INPUT_BUFFER			0x800
#define EIP93_OUTPUT_BUFFER			0x800

/* NOT PRESENT ON AIROHA
